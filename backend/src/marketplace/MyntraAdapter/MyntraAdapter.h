// PLANNED — not implemented yet. Myntra's real seller API is not
...
class MyntraAdapter : public MarketplaceAdapter {
public:
    std::string marketplaceName() const override { return "Myntra"; }
